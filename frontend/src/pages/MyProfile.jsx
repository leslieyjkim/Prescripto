...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email: 'rechardJameswap@hotmail.com',
    phone:'+1 123 444 5555',
    address:{
      line1:"57th Cross, Richmond Hill ",
  ...
  const [isEdit, setIsEdit] = useState(false) //If the state is 'true' the information editable in the input box.
